...
{
    public partial class pageCategories_groupSystem_Position : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void Refreshed(string CallBy)
        {
            ...
            try
            {
                pageCategories_groupSystem_Position_Load(null, null);
            }
            catch (Exception ex)
            {
        ...
        public void New(string CallBy)
        {
            ...
            try
            {
                ...
                {
                    selectedID = int.Parse(frmEdit.positionID);
                    pageCategories_groupSystem_Position_Load(null, null);
                }
            }
            catch (Exception ex)
        ...
        public void Edit(string CallBy)
        {
            ...
            try
            {
                if (gvPosition.FocusedRowHandle < 0)
                {
                ...
                selectedID = int.Parse(gvPosition.GetFocusedRowCellValue(colID).ToString());

                pageCategories_groupSystem_Position_Edit frmEdit = new pageCategories_groupSystem_Position_Edit();
                frmEdit.typeAction = Utilities.Parameters.Permission_EDIT;
                frmEdit.positionID = selectedID.ToString();
                DialogResult dlg = frmEdit.ShowDialog();
                if (dlg == DialogResult.OK)
                    pageCategories_groupSystem_Position_Load(null, null);
            }
        ...
        public pageCategories_groupSystem_Position()
        {
            InitializeComponent();
            ...
            if (arrIndex == -1)
            {
                Utilities.Functions.MessageBoxOK("E", Utilities.Parameters.Error, "Không tìm thấy arrIndex của Danh mục Chức vụ.");
                this.Close();
            }
        }

        private void pageCategories_groupSystem_Position_FormClosed(object sender, FormClosedEventArgs e)
        {
        ...
        private void pageCategories_groupSystem_Position_Activated(object sender, EventArgs e)
        {
            string callFrom = Utilities.Parameters.ComputerName + System.Reflection.MethodBase.GetCurrentMethod().DeclaringType + " -> " + System.Reflection.MethodBase.GetCurrentMethod().Name;
        ...
        private void pageCategories_groupSystem_Position_Load(object sender, EventArgs e)
        {
            string callFrom = Utilities.Parameters.ComputerName + System.Reflection.MethodBase.GetCurrentMethod().DeclaringType + " -> " + System.Reflection.MethodBase.GetCurrentMethod().Name;
            try
            {
                ...
                if (selectedID > 0)
                    ...
                    {
                        if (gvPosition.GetRowCellValue(i, colID) != null && gvPosition.GetRowCellValue(i, colID).ToString() == selectedID.ToString())
                        {
                            gvPosition.SelectRow(i);
                            gvPosition.FocusedRowHandle = i;
                            break;
                        }
                    }
                ...
                if (dtPosition == null || dtPosition.Rows.Count == 0)
                    frmMain.EnableAction(true, false, false, false, false, true, false, false, false, arrIndex);
                gvPosition_FocusedRowChanged(null, null);
            }
            catch (Exception ex)
            {
                Utilities.Functions.WriteLog(Utilities.Parameters.LogErrorPath, callFrom + ":\n" + ex.Message);
        ...
        private void gvPosition_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            string callFrom = Utilities.Parameters.ComputerName + System.Reflection.MethodBase.GetCurrentMethod().DeclaringType + " -> " + System.Reflection.MethodBase.GetCurrentMethod().Name;
            try
            {
