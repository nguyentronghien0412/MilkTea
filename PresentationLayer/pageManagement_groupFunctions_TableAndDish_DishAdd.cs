...
{
    public partial class pageManagement_groupFunctions_TableAndDish_DishAdd : DevExpress.XtraEditors.XtraForm
    {
        public DataTable vdtOrderDetail = null;
        public int vOrderID = 0;
        ...
        public pageManagement_groupFunctions_TableAndDish_DishAdd()
        {
            InitializeComponent();
        ...
        private void pageManagement_groupFunctions_TableAndDish_DishAdd_Load(object sender, EventArgs e)
        {
            string callFrom = Utilities.Parameters.ComputerName + System.Reflection.MethodBase.GetCurrentMethod().DeclaringType + " -> " + System.Reflection.MethodBase.GetCurrentMethod().Name;
            try
            {
                ...
                Populate_LookUpEdit(gvOrderDetail_colUnitID_rlk, "Unit");
                Populate_LookUpEdit(gvOrderDetail_colMenuID_rslk_view_colUnitID_rlk, "Unit");
                Populate_LookUpEdit(gvOrderDetail_colMenuGroupID_rlk, "MenuGroup");
                Populate_LookUpEdit(gvOrderDetail_colMenuID_rslk_view_colMenuGroupID_view, "MenuGroup");
                Populate_LookUpEdit(gvOrderDetail_colKindOfHotpot1ID_lke, "KindOfHotpot");
                Populate_LookUpEdit(gvOrderDetail_colSizeID_lk, "Size");

                #region gvOrderDetail_colMenuID_rslk

                DataTable dtMenu = new DataTable();
                string result = bMenu.GetAll_IsActive(callFrom, ref dtMenu);
                if (result != Utilities.Parameters.ResultMessage)
                {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string result = bOrder.OrderDetail_Insert(callFrom, ref vdtOrderDetail, vOrderID);
