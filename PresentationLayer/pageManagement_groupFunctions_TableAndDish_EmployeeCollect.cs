...
{
    public partial class pageManagement_groupFunctions_TableAndDish_EmployeeCollect : DevExpress.XtraEditors.XtraForm
    {
        ...
        public pageManagement_groupFunctions_TableAndDish_EmployeeCollect()
        {
            InitializeComponent();
        }
        ...
        private void pageManagement_groupFunctions_TableAndDish_EmployeeCollect_Load(object sender, EventArgs e)
        {
            string callFrom = Utilities.Parameters.ComputerName + System.Reflection.MethodBase.GetCurrentMethod().DeclaringType + " -> " + System.Reflection.MethodBase.GetCurrentMethod().Name;
            try
            {
