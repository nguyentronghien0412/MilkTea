...
{
    public partial class pageManagement_groupFunctions_TableAndDish_rptPromotion : DevExpress.XtraReports.UI.XtraReport
    {
        public pageManagement_groupFunctions_TableAndDish_rptPromotion()
        {
            InitializeComponent();
        ...
        public void BindData_Information(dtoPrintBill PrintBill)
        {
            ...
            if (PrintBill.PromotionPercent != "")
                lbPromotionPercent.Text = lbPromotionPercent.Text + " " + PrintBill.PromotionPercent + "%";

            lbPromotionAmount.Text = PrintBill.PromotionAmount;
            lbPaymentedAmount.Text = PrintBill.PaymentedAmount;
