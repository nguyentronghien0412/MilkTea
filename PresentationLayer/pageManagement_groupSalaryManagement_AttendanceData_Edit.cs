...
{
    public partial class pageManagement_groupSalaryManagement_AttendanceData_Edit : DevExpress.XtraEditors.XtraForm
    {
        public string _AttendanceDataID = "";
        ...
        public pageManagement_groupSalaryManagement_AttendanceData_Edit()
        {
            InitializeComponent();
        }
        ...
        private void pageManagement_groupSalaryManagement_AttendanceData_Edit_Load(object sender, EventArgs e)
        {
            string callFrom = Utilities.Parameters.ComputerName + System.Reflection.MethodBase.GetCurrentMethod().DeclaringType + " -> " + System.Reflection.MethodBase.GetCurrentMethod().Name;
            Utilities.Multi.ChangeBackColor_RequiredControl(callFrom, this, "*", Utilities.Parameters.Definition.COLOR_REQUIRED);
            try
            {
                if (_AttendanceDataID == "")
                {
                    Utilities.Functions.MessageBoxOK("E", Utilities.Parameters.Error, "Không tìm thấy mã Dữ liệu chấm công.");
                    return;
                }
                ...
                string _Result = bGeneral.GetByCondition(callFrom, ref _dtAttendanceData, "AttendanceData", new string[] { "ID" }, new string[] { _AttendanceDataID }, null);
                ...
                if (int.Parse(_AttendanceDataID) == 0)
                {
                    this.Text = "Dữ liệu chấm công - Tạo mới";
                ...
                {
                    this.Text = "Dữ liệu chấm công - Cập nhật";
                }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string result = "";
                if (int.Parse(_AttendanceDataID) == 0)
                    result = bGeneral.Insert(callFrom, ref _dtAttendanceData, true);
                else
                    result = bGeneral.UpdateByID(callFrom, _dtAttendanceData);
                ...
                {
                    _AttendanceDataID = _dtAttendanceData.Rows[0]["ID"].ToString();
